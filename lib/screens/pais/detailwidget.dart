...
class DetalhesPaisPage extends StatefulWidget {

  int id;
  DetalhesPaisPage({Key key, this.id}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return DetalhesPaisPageState();
  }
}

class DetalhesPaisPageState extends State<DetalhesPaisPage> {
  @override
