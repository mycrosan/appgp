...
class DetalhesAntiquebraPage extends StatefulWidget {

  int id;
  DetalhesAntiquebraPage({Key key, this.id}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return DetalhesAntiquebraPageState();
  }
}

class DetalhesAntiquebraPageState extends State<DetalhesAntiquebraPage> {
  @override
