...
class AdicionarProducaoPageState extends State<AdicionarProducaoPage> {
  ...
  void initState() {
    ...
    // medidaCarcaca = TextEditingController();
    // modeloCarcaca = TextEditingController();
    // paisCarcaca = TextEditingController();
            ...
            Container(
              child: mostrarCarcacaSelecionada
                ...
                child: ListTile(
                  ...
                  subtitle: Text(
                      'Medida: ' + medidaCarcaca.descricao +
                      ' DOT: ' + producao.carcaca.dot +
                      ' Modelo: ' + modeloCarcaca.descricao +
                      ' Pais: ' + paisCarcaca.descricao),
                ),
              )
                  : Text(''),
            ),
