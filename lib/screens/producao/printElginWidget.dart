...
//
// class PrintElginPage extends StatefulWidget {
//
//   Producao producaoPrint;
//
//   PrintElginPage({Key key, this.producaoPrint}) : super(key: key);
//
//   @override
...
// }
//
// class _MyHomePageState extends State<PrintElginPage> {
...
//                     onPressed: isDiscovering ? null : () => testPrint('192.168.0.31', context)),
//                 SizedBox(height: 15),
//                 found >= 0
...
//                       return InkWell(
//                         onTap: () => testPrint('192.168.0.31', context),
//                         child: Column(
//                           children: <Widget>[
//                             Container(
//                               height: 60,
...
//                                       child: Text(
//                                            'Imprimir'),
//                                       onPressed: () => testPrint(devices[index], context)),
