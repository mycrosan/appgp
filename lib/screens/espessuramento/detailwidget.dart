...
class DetalhesEspessuramentoPage extends StatefulWidget {

  int id;
  DetalhesEspessuramentoPage({Key key, this.id}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return DetalhesEspessuramentoPageState();
  }
}

class DetalhesEspessuramentoPageState extends State<DetalhesEspessuramentoPage> {
  @override
