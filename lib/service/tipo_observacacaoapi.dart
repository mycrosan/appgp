...
class TipoObservacacaoApi extends ChangeNotifier {

  static const ENDPOINT = 'tipoobservacao';

  Future<List<TipoObservacao>> getAll() async {
    ...
    if (response.statusCode == 200) {
      ...
      return body.map((values) => TipoObservacao.fromJson(values)).toList();
    } else {
